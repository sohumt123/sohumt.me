...
class App {
  ...
  constructor(container: HTMLElement, options: HyperspeedOptions) {
    ...
    this.camera = new THREE.PerspectiveCamera(options.fov, window.innerWidth / window.innerHeight, 0.1, 10000);
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {} }) => {
  ...
  return <div id="lights" style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', display: 'block', margin: 0, padding: 0 }} ref={hyperspeed}></div>;
};
